...
#define KALEIDOGLYPH_KEYADDR_H <model01/KeyAddr.h>
#define KALEIDOGLYPH_LEDADDR_H <model01/LedAddr.h>
#define KALEIDOGLYPH_COLOR_H   <model01/Color.h>

// This is the main hardware class `kaleidoglyph::hardware::Keyboard`. It provides both
// that and widely-used constant `kaleidoglyph::hardware::total_keys`:
#define KALEIDOGLYPH_HARDWARE_KEYBOARD_H <model01/Keyboard.h>
...
// itself:
#define KALEIDOGLYPH_HID_H <Kaleidoglyph-HID.h>
